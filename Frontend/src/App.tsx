...
import AdminPage from './components/AdminPage/AdminProduct'; 
import ForgetPassword from './components/ForgotPassword/ForgetPassword';
import SecondForgetPassword from './components/ForgotPassword/SecondForgetPassword';
    ...
    <WishlistProvider>
      <Router>
        <Routes>
          ...
          <Route path= "/secondfpw" element={<SecondForgetPassword />}/>
