...
import backgroundImage from "../../assets/Logo/login_background.png"; // Make sure the path is correct
    ...
    <>
      ...
      <div className="privacy-policy-container">
        ...
        <p>
          ...
          information. However, we may share your data with trusted third parties to:
        </p>
        <ul>
