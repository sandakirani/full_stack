...
import Navbar from "../home/navbar"; // Ensure Navbar is properly imported
import Footer from "../home/Footer"; // Ensure Footer is properly imported
import "./WarrantyPolicy.css"; // Import the CSS for the page
import backgroundImage from "../assets/login_background.png"; // Replace with actual background image path
