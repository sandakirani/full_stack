...
const productData: {
  ...
  1: {
    ...
    Design: {
      ...
      Weight: "227 grams.",
      Display:
        "6.9-inch Super Retina XDR OLED with a resolution of 2868 x 1320 pixels at 460 ppi. Features include Dynamic Island, Always-On display, and ProMotion technology with adaptive refresh rates up to 120Hz.",
    },
    Performance: {
      Processor:
        "Powered by the Apple A18 Pro chip, delivering up to 30% faster performance with 3-nanometer technology.",
      Memory: "Equipped with 8GB of RAM.",
    },
    Camera: {
      Rear: [
        "48MP Main (f/1.78 aperture) with sensor-shift optical image stabilization.",
      ...
      Features:
        "Advanced AI-powered photography enhancements, including improved low-light performance and macro mode support.",
    },
    Battery: {
      life: "Enhanced battery life due to improved performance and power efficiency.",
      charging:
        "Supports MagSafe and Qi 2 wireless charging, along with USB-C fast charging capabilities.",
    },
    connectivity: {
      ...
      ports:
        "Features a USB-C port with USB 3.2 support for data transfer speeds up to 10Gb/s.",
    },
  ...
  2: {
    ...
    Design: {
      ...
      Weight: "235 grams.",
      Display:
        "6.9-inch Super Retina XDR OLED with a resolution of 2872 x 1344 pixels at 465 ppi. Features include Dynamic Island, Always-On display, ProMotion technology with adaptive refresh rates up to 120Hz, and True Tone.",
    },
    Performance: {
      Processor:
        "Powered by the Apple A19 Pro chip, delivering up to 35% faster performance with 3-nanometer technology and enhanced AI capabilities.",
      Memory: "Equipped with 12GB of RAM.",
    },
    Camera: {
      Rear: [
        "50MP Main (f/1.7 aperture) with sensor-shift optical image stabilization and advanced AI-assisted image processing.",
      ...
      Front:
        "14MP TrueDepth camera with f/1.8 aperture and improved autofocus for clearer selfies.",
      Features:
        "AI-powered photography enhancements, including better night mode, real-time object detection, macro mode, and improved video stabilization.",
    },
    Battery: {
      life: "Enhanced battery life with more efficient power management, offering up to 20 hours of video playback.",
      charging:
        "Supports MagSafe and Qi 2 wireless charging, along with USB-C fast charging capabilities for quicker power-ups.",
    },
    connectivity: {
      network:
        "Compatible with 5G NR, 4G LTE, and other global networks for improved connectivity.",
      wifi: "Supports Wi-Fi 8 dual-band for ultra-fast wireless speeds.",
      bluetooth:
        "Equipped with Bluetooth 5.4 for faster and more reliable wireless connections.",
      ports:
        "Features a USB-C port with USB 4.0 support for data transfer speeds up to 20Gb/s.",
    },
  ...
  3: {
    ...
    Design: {
      ...
      Weight: "245 grams.",
      Display:
        "6.9-inch Super Retina XDR OLED with a resolution of 2872 x 1344 pixels at 465 ppi. Features Dynamic Island, Always-On display, ProMotion technology with adaptive refresh rates up to 120Hz, and True Tone.",
    },
    Performance: {
      Processor:
        "Powered by the Apple A19 Pro chip, with 3-nanometer technology and advanced AI processing.",
      Memory: "12GB of RAM.",
    },
    Camera: {
      Rear: [
        "50MP Main (f/1.7 aperture) with sensor-shift optical image stabilization.",
  ...
  4: {
    ...
    Design: {
      ...
      Weight: "221 grams.",
      Display:
        " 6.7-inch Super Retina XDR OLED with a resolution of 2796 x 1290 pixels at 460 ppi. Features Dynamic Island, Always-On display, ProMotion technology, and True Tone.",
    },
    Performance: {
      Processor:
        "Powered by the Apple A18 Pro chip with 3-nanometer technology.",
      Memory: "8GB of RAM.",
    },
    Camera: {
      Rear: [
  ...
  5: {
    ...
    Design: {
      ...
      Weight: "187 grams.",
      Display:
        "6.1-inch Super Retina XDR OLED with a resolution of 2532 x 1170 pixels at 460 ppi. Features Dynamic Island, Always-On display, ProMotion technology, and True Tone.",
    },
    Performance: {
      Processor:
        "Powered by the Apple A18 Pro chip with 3-nanometer technology.",
  ...
  6: {
    ...
    Design: {
      ...
      Weight: "203 grams.",
      Display:
        "6.7-inch Super Retina XDR OLED with a resolution of 2778 x 1284 pixels at 458 ppi. Features Dynamic Island and True Tone.",
    },
    Performance: {
  ...
  7: {
    ...
    Design: {
      ...
      Weight: "171 grams.",
      Display:
        "6.1-inch Super Retina XDR OLED with a resolution of 2532 x 1170 pixels at 460 ppi.",
    },
    Performance: {
      Processor: "Powered by the Apple A16 Bionic chip.",
      Memory: "6GB of RAM.",
    ...
    Camera: {
      ...
      Front: "12MP TrueDepth camera with f/1.9 aperture.",
      Features:
        "Night mode, Smart HDR 5, Cinematic Mode, and Action Mode for enhanced video stabilization.",
    },
    Battery: {
  ...
  8: {
    ...
    Design: {
      ...
      Weight: "203 grams.",
      Display:
        "6.7-inch Super Retina XDR OLED with a resolution of 2778 x 1284 pixels at 458 ppi.",
    },
    Performance: {
    ...
    Camera: {
      Rear: [
        "12MP Main (f/1.5 aperture).",
        "12MP Ultra-Wide (f/2.4 aperture).",
      ],
      Front: "12MP TrueDepth camera with f/1.9 aperture.",
      Features:
        "Deep Fusion, Night mode, Smart HDR 4, and Cinematic Mode for professional-quality videos.",
    },
    Battery: {
      life: "Up to 26 hours of video playback.",
  ...
  9: {
    ...
    Camera: {
      ...
      Front: "12MP TrueDepth camera with f/1.9 aperture.",
      Features:
        "Night mode, Smart HDR 4, and Photographic Styles for personalized photo settings.",
    },
    Battery: {
  ...
  return (
    <div className="product-page">
        ...
        {product.storageOptions.map((option, index) => (
          <button
            ...
            className={`storage-option-btn ${
              selectedStorage === option ? "selected" : ""
            }`}
          >
            {option}
          </button>
      ...
      <ul className="des1">
        ...
        <li>
          <strong>Front Camera:</strong> {product.Camera.Front}
        </li>
        <li>
          <strong>Features:</strong> {product.Camera.Features}
        </li>
      </ul>
