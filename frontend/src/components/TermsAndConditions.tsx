...
const terms = [
  ...
  {
    title: "Payment Terms",
    content: `• We accept [list payment methods, e.g., credit cards, PayPal, etc.].\n• Payments must be made in full at the time of purchase. Transactions are processed securely to protect your information.`,
  },
  {
  ...
  },
  {
    ...
    content: `• All content on this website, including text, graphics, logos, and images, is the property of [Your Mobile Shop Name] and is protected by copyright laws.\n• You may not use any content without prior written consent.`,
  },
  {
  ...
  {
    title: "Governing Law",
    content: `• These terms are governed by the laws of [Your Country/State]. Any disputes arising from these terms will be resolved in the courts of [Your Jurisdiction].`,
  },
  {
